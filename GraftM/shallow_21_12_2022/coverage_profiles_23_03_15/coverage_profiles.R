...
hits_pmoA<-vroom("/user_data/kalinka/GraftM/GraftM_packages/coverage_profiles_23_03_15/Position_files/position_of_pmoA_hits.tsv", delim = "\t")
hits_pmoA <- hits_pmoA %>%
...
ggsave("/user_data/kalinka/GraftM/GraftM_packages/coverage_profiles_23_03_15/Coverage_plots/cov_pmoA.png",
       cov_tax,
       height = 15,
       width = 15)
...
pmoA_diff_bar<-ggplot(pmoA_diff, aes(x = Taxonomy, y = ratio_cov, color =Taxonomy)) +
...
ggsave("/user_data/kalinka/GraftM/GraftM_packages/coverage_profiles_23_03_15/Coverage_plots/ratio_cov_pmoA.png",
       pmoA_diff_bar,
       height = 13,
       width = 15)
